...
那么什么有用呢？当然是GPS导航。导航提供了两种信息，一是你当前的位置信息，二是为了达到目的地，你的下一步最优路线。导航的信息只专注于当下，致力于解决眼前的、却是以最终目标为导向的局部问题。这给我们提供了明确的行动指南是有效的信息。这就是灯式的认知。
...
因此，真正可怕的是自己的认知或者说意识，陷入被动，局限在别人设置好的轨道上，不断播放已有认知。
